...
public class OdcitaniDoTisice {
    public void vypis(){
        Scanner sc = new Scanner(System.in, "UTF-8");

        GenerovaniPrikladu generovaniPrikladu = new GenerovaniPrikladu();

        System.out.println("Kolik chcete vygenerovat příkladu pro odčítání ? (Od 1 do 100)");
        ...
        if((pocet>0) && (pocet<101)) {
            ...
            List<Priklad> prikladyProUcitele = generovaniPrikladu.proUciteleOdcitani();
